...
public class GuestbookModelPermission {
	...
	public static boolean contains(PermissionChecker permissionChecker,
		...
		return _guestbookModelResourcePermission.contains(permissionChecker, guestbook,
			actionId);
	}
	...
	public static boolean contains(PermissionChecker permissionChecker, long guestbookId,
		...
		return _guestbookModelResourcePermission.contains(permissionChecker, guestbookId,
			actionId);
	}
