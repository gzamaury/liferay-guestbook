...
public class GuestbookEntryPermission {
	...
	public static boolean contains(PermissionChecker permissionChecker,
		...
		return _guestbookEntryModelResourcePermission.contains(permissionChecker, entry,
			actionId);
	}
	...
	public static boolean contains(PermissionChecker permissionChecker, long entryId,
		...
		return _guestbookEntryModelResourcePermission.contains(permissionChecker, entryId,
			actionId);
	}
