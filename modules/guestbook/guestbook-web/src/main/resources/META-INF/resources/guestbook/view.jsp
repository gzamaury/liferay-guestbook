	...
	<%
		List<Guestbook> guestbooks =
			...
			for (int i = 0; i < guestbooks.size(); i++) {
				...
				if (GuestbookModelPermission.contains(permissionChecker,
					curGuestbook.getGuestbookId(), ActionKeys.VIEW)) {
	%>
...
<aui:button-row cssClass="guestbook-buttons">
	<c:if
		test='<%=GuestbookModelPermission.contains(permissionChecker, guestbookId,
